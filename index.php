...
<head>
    ...
    <title>FB Serviços | Sistema de Aprendizado...</title>
</head>
<body>
    <div class="container">
  ...
  <div class="container-fluid">
    ...
    <img src="fbservicos.png" title="Logo da FB Serviços...">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="acessar.php">
        ...
        <li class="nav-item dropdown">
          ...
          Relatórios e Ferramentas Adicionais
          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Clientes</a></li>
            <li><a class="dropdown-item" href="#">Serviços</a></li>
            <li><a class="dropdown-item" href="#">Documentos Internos</a></li>
          </ul>
        </li>
      </ul>
    </div>
